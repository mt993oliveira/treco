...
const CONFIG_DEFAULTS = [
    ...
    { chave:'grid_selColBg',  valor:'#1e3a5f',  tipo:'color',  grupo:'grid', descricao:'🔵 Coluna selecionada: fundo' },
    { chave:'grid_selColTxt', valor:'#60a5fa',  tipo:'color',  grupo:'grid', descricao:'🔵 Coluna selecionada: texto' },
    { chave:'grid_selColBrd', valor:'#3b82f6',  tipo:'color',  grupo:'grid', descricao:'🔵 Coluna selecionada: borda' },
